...
module credit_reg ( clk, rst, cancel, clear, load, coin_value, credit );
  ...
  DFFSSRX1_RVT credit_reg_0_ ( .D(1'b0), .SETB(1'b0), .RSTB(n11), .CLK(clk), 
        .Q(credit[0]), .QN(n48) );
  DFFSSRX1_RVT credit_reg_6_ ( .D(1'b0), .SETB(1'b0), .RSTB(n5), .CLK(clk), 
        .Q(credit[6]), .QN(n49) );
endmodule
...
module memory ( clk, rst, mem_read, mem_write, addr, price, stock );
  ...
  wire   n30, n31, n32, n33, n34, n38, n39, n40, n41, n42, n43, n44, n48, n49,
         ...
         n73, n74, n75, n76, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n14,
         n15, n16, n17, n18, n19, n20, n21, n22, n23, n24, n25, n26, n27, n28,
         n29, n35, n36, n37, n45, n46, n47, n53, n54, n55, n61, n63, n69, n70,
         n71, n77, n78, n79;
  wire   [19:0] mem;

  INVX0_RVT U10 ( .A(rst), .Y(n37) );
  INVX0_RVT U11 ( .A(addr[0]), .Y(n61) );
  NAND2X0_RVT U12 ( .A1(addr[1]), .A2(addr[0]), .Y(n46) );
  MUX41X1_RVT U14 ( .A1(mem[19]), .A3(mem[9]), .A2(mem[14]), .A4(mem[4]), .S0(
        addr[1]), .S1(addr[0]), .Y(n63) );
  MUX41X1_RVT U15 ( .A1(mem[18]), .A3(mem[8]), .A2(mem[13]), .A4(mem[3]), .S0(
        addr[1]), .S1(addr[0]), .Y(n69) );
  MUX41X1_RVT U16 ( .A1(mem[17]), .A3(mem[7]), .A2(mem[12]), .A4(mem[2]), .S0(
        addr[1]), .S1(addr[0]), .Y(n70) );
  MUX41X1_RVT U17 ( .A1(mem[15]), .A3(mem[5]), .A2(mem[10]), .A4(mem[0]), .S0(
        addr[1]), .S1(addr[0]), .Y(n77) );
  MUX41X1_RVT U18 ( .A1(mem[16]), .A3(mem[6]), .A2(mem[11]), .A4(mem[1]), .S0(
        addr[1]), .S1(addr[0]), .Y(n71) );
  OR2X1_RVT U19 ( .A1(n77), .A2(n71), .Y(n8) );
  OR2X1_RVT U20 ( .A1(n70), .A2(n8), .Y(n10) );
  OR2X1_RVT U21 ( .A1(n69), .A2(n10), .Y(n12) );
  OR2X1_RVT U22 ( .A1(n63), .A2(n12), .Y(n3) );
  NAND2X0_RVT U24 ( .A1(n3), .A2(mem_write), .Y(n22) );
  OA21X1_RVT U25 ( .A1(n46), .A2(n22), .A3(n37), .Y(n15) );
  INVX0_RVT U26 ( .A(n77), .Y(n4) );
  INVX0_RVT U27 ( .A(n15), .Y(n6) );
  AND2X1_RVT U28 ( .A1(n37), .A2(n6), .Y(n14) );
  AO22X1_RVT U29 ( .A1(mem[0]), .A2(n15), .A3(n4), .A4(n14), .Y(n76) );
  INVX0_RVT U30 ( .A(n8), .Y(n5) );
  AO21X1_RVT U31 ( .A1(n77), .A2(n71), .A3(n5), .Y(n25) );
  AO221X1_RVT U32 ( .A1(n25), .A2(n6), .A3(n15), .A4(mem[1]), .A5(rst), .Y(n75) );
  INVX0_RVT U33 ( .A(n10), .Y(n7) );
  AO21X1_RVT U34 ( .A1(n70), .A2(n8), .A3(n7), .Y(n27) );
  AO22X1_RVT U35 ( .A1(mem[2]), .A2(n15), .A3(n14), .A4(n27), .Y(n74) );
  INVX0_RVT U36 ( .A(n12), .Y(n9) );
  AO21X1_RVT U37 ( .A1(n69), .A2(n10), .A3(n9), .Y(n28) );
  AO22X1_RVT U38 ( .A1(mem[3]), .A2(n15), .A3(n14), .A4(n28), .Y(n73) );
  INVX0_RVT U39 ( .A(n3), .Y(n11) );
  AO21X1_RVT U40 ( .A1(n63), .A2(n12), .A3(n11), .Y(n29) );
  AO22X1_RVT U41 ( .A1(mem[4]), .A2(n15), .A3(n14), .A4(n29), .Y(n72) );
  ...
  AO22X1_RVT U46 ( .A1(n18), .A2(mem[5]), .A3(n16), .A4(n24), .Y(n68) );
  AO221X1_RVT U47 ( .A1(n25), .A2(n16), .A3(n18), .A4(mem[6]), .A5(rst), .Y(
        n67) );
  AND2X1_RVT U48 ( .A1(n37), .A2(n16), .Y(n17) );
  AO22X1_RVT U49 ( .A1(mem[7]), .A2(n18), .A3(n17), .A4(n27), .Y(n66) );
  AO22X1_RVT U50 ( .A1(mem[8]), .A2(n18), .A3(n17), .A4(n28), .Y(n65) );
  AO22X1_RVT U51 ( .A1(mem[9]), .A2(n18), .A3(n17), .A4(n29), .Y(n64) );
  ...
  AO22X1_RVT U56 ( .A1(n21), .A2(mem[10]), .A3(n19), .A4(n24), .Y(n60) );
  AND2X1_RVT U57 ( .A1(n37), .A2(n19), .Y(n20) );
  AO22X1_RVT U58 ( .A1(mem[11]), .A2(n21), .A3(n20), .A4(n25), .Y(n59) );
  AO221X1_RVT U59 ( .A1(n27), .A2(n19), .A3(n21), .A4(mem[12]), .A5(rst), .Y(
        n58) );
  AO22X1_RVT U60 ( .A1(mem[13]), .A2(n21), .A3(n20), .A4(n28), .Y(n57) );
  AO22X1_RVT U61 ( .A1(mem[14]), .A2(n21), .A3(n20), .A4(n29), .Y(n56) );
  NAND2X0_RVT U62 ( .A1(n45), .A2(n61), .Y(n23) );
  OA21X1_RVT U63 ( .A1(n23), .A2(n22), .A3(n37), .Y(n36) );
  INVX0_RVT U64 ( .A(n36), .Y(n26) );
  AO22X1_RVT U65 ( .A1(n36), .A2(mem[15]), .A3(n26), .A4(n24), .Y(n52) );
  AND2X1_RVT U66 ( .A1(n37), .A2(n26), .Y(n35) );
  AO22X1_RVT U67 ( .A1(mem[16]), .A2(n36), .A3(n35), .A4(n25), .Y(n51) );
  AO221X1_RVT U68 ( .A1(n27), .A2(n26), .A3(n36), .A4(mem[17]), .A5(rst), .Y(
        n50) );
  AO22X1_RVT U69 ( .A1(mem[18]), .A2(n36), .A3(n35), .A4(n28), .Y(n49) );
  AO22X1_RVT U70 ( .A1(mem[19]), .A2(n36), .A3(n35), .A4(n29), .Y(n48) );
...
module comparator ( credit, price, stock, can_sell );
  ...
  input [7:0] stock;
  output can_sell;
  wire   n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n16, n18;
  ...
  OR4X1_RVT U19 ( .A1(stock[3]), .A2(stock[2]), .A3(stock[1]), .A4(stock[0]), 
        .Y(n16) );
  OA22X1_RVT U20 ( .A1(credit[7]), .A2(n18), .A3(stock[4]), .A4(n16), .Y(
        can_sell) );
endmodule
...
module subtractor ( credit, price, change );
  ...
  INVX0_RVT U1 ( .A(intadd_0_SUM_5_), .Y(change[6]) );
  INVX0_RVT U2 ( .A(intadd_0_SUM_2_), .Y(change[3]) );
  INVX0_RVT U3 ( .A(intadd_0_SUM_4_), .Y(change[5]) );
  XOR2X1_RVT U4 ( .A1(intadd_0_n1), .A2(credit[7]), .Y(change[7]) );
  INVX0_RVT U5 ( .A(intadd_0_SUM_0_), .Y(change[1]) );
  INVX0_RVT U6 ( .A(intadd_0_SUM_1_), .Y(change[2]) );
  INVX0_RVT U7 ( .A(intadd_0_SUM_3_), .Y(change[4]) );
  INVX0_RVT U8 ( .A(price[0]), .Y(n1) );
  NOR2X0_RVT U9 ( .A1(n1), .A2(credit[0]), .Y(intadd_0_CI) );
  INVX0_RVT U10 ( .A(credit[5]), .Y(intadd_0_B_4_) );
  INVX0_RVT U11 ( .A(credit[1]), .Y(intadd_0_B_0_) );
  INVX0_RVT U12 ( .A(credit[2]), .Y(intadd_0_B_1_) );
  INVX0_RVT U13 ( .A(credit[3]), .Y(intadd_0_B_2_) );
  INVX0_RVT U14 ( .A(credit[4]), .Y(intadd_0_B_3_) );
...
module control_unit ( clk, rst, cancel, coin_in, confirm, can_sell, state, 
  ...
  output credit_load, credit_clear, mem_read, mem_write, dispense, error,
         change_load;
  wire   check_wait, N22, n1, n2, n5, n6, n7, n8, n10, n11, n12, n13, n17, n18,
         n19, n20, n21, n24;

  DFFSSRX1_RVT check_wait_reg ( .D(n21), .SETB(1'b1), .RSTB(n20), .CLK(clk), 
        .Q(check_wait), .QN(n19) );
  OAI222X1_RVT U3 ( .A1(n17), .A2(can_sell), .A3(n17), .A4(n18), .A5(state[1]), 
        .A6(n12), .Y(n1) );
  AND2X1_RVT U5 ( .A1(n21), .A2(n24), .Y(n2) );
  AND3X1_RVT U9 ( .A1(state[1]), .A2(state[0]), .A3(n24), .Y(dispense) );
  NBUFFX2_RVT U10 ( .A(dispense), .Y(mem_write) );
  NOR2X0_RVT U11 ( .A1(rst), .A2(cancel), .Y(n21) );
  AND2X1_RVT U12 ( .A1(n24), .A2(n17), .Y(n6) );
  OR2X1_RVT U13 ( .A1(coin_in[0]), .A2(coin_in[1]), .Y(n5) );
  AND2X1_RVT U14 ( .A1(n6), .A2(n5), .Y(credit_load) );
  AO222X1_RVT U15 ( .A1(n24), .A2(state[1]), .A3(n24), .A4(coin_in[1]), .A5(
        n24), .A6(coin_in[0]), .Y(n7) );
  OA222X1_RVT U16 ( .A1(n17), .A2(check_wait), .A3(n17), .A4(n18), .A5(
        state[0]), .A6(n7), .Y(n8) );
  AND2X1_RVT U17 ( .A1(n8), .A2(n21), .Y(n10) );
  NAND2X0_RVT U18 ( .A1(state[0]), .A2(confirm), .Y(n11) );
  AND2X1_RVT U21 ( .A1(state[2]), .A2(n17), .Y(change_load) );
  AND2X1_RVT U22 ( .A1(change_load), .A2(n18), .Y(credit_clear) );
  AND4X1_RVT U23 ( .A1(state[1]), .A2(n18), .A3(n24), .A4(n19), .Y(mem_read)
         );
  INVX0_RVT U24 ( .A(n11), .Y(n12) );
  AND2X1_RVT U25 ( .A1(state[0]), .A2(change_load), .Y(error) );
  NOR4X1_RVT U26 ( .A1(state[2]), .A2(can_sell), .A3(n17), .A4(n19), .Y(n13)
         );
  AO222X1_RVT U27 ( .A1(n21), .A2(n13), .A3(n21), .A4(dispense), .A5(n21), 
        .A6(error), .Y(N22) );
  AO221X1_RVT U28 ( .A1(check_wait), .A2(change_load), .A3(check_wait), .A4(
        dispense), .A5(mem_read), .Y(n20) );
  DFFSSRX1_RVT current_state_reg_0_ ( .D(n11), .SETB(n24), .RSTB(n10), .CLK(
        clk), .Q(state[0]), .QN(n18) );
  DFFSSRX1_RVT current_state_reg_1_ ( .D(mem_read), .SETB(n1), .RSTB(n2), 
        .CLK(clk), .Q(state[1]), .QN(n17) );
  DFFSSRX1_RVT current_state_reg_2_ ( .D(1'b0), .SETB(1'b0), .RSTB(N22), .CLK(
        clk), .Q(state[2]), .QN(n24) );
endmodule
...
module vending_top ( clk, rst, coin_in, sel_item, confirm, cancel, dispense, 
  ...
  wire   credit_clear, credit_load, mem_read, mem_write, can_sell, change_load,
         n10, n11, n12, n13, n14, n15, n16, n17, n18, n19, n20, n21, n22, n26,
  ...
  INVX0_RVT U32 ( .A(coin_in[1]), .Y(n26) );
  NOR2X0_RVT U33 ( .A1(n26), .A2(coin_in[0]), .Y(coin_value[1]) );
  AND2X1_RVT U34 ( .A1(coin_in[0]), .A2(n26), .Y(coin_value[3]) );
  OR2X1_RVT U35 ( .A1(coin_value[1]), .A2(coin_value[3]), .Y(n18) );
  AND2X1_RVT U36 ( .A1(coin_in[0]), .A2(coin_in[1]), .Y(coin_value[6]) );
  INVX0_RVT U39 ( .A(state_out[1]), .Y(n27) );
  NAND3X0_RVT U40 ( .A1(state_out[0]), .A2(state_out[2]), .A3(n27), .Y(n29) );
  INVX0_RVT U41 ( .A(n29), .Y(n28) );
  INVX0_RVT U42 ( .A(rst), .Y(n31) );
  OA221X1_RVT U43 ( .A1(cancel), .A2(change_load), .A3(cancel), .A4(n28), .A5(
        n31), .Y(n34) );
  NOR3X0_RVT U44 ( .A1(rst), .A2(cancel), .A3(change_load), .Y(n32) );
  INVX0_RVT U45 ( .A(cancel), .Y(n30) );
