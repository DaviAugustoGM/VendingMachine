...
module subtractor ( credit, price, change );
  ...
  input [7:0] price;
  output [7:0] change;
  wire   intadd_4_B_5_, intadd_4_B_4_, intadd_4_B_3_, intadd_4_B_2_,
         ...
         intadd_4_n2, intadd_4_n1, n1;

  FADDX1_RVT intadd_4_U7 ( .A(intadd_4_B_0_), .B(price[1]), .CI(intadd_4_CI), 
        .CO(intadd_4_n6), .S(intadd_4_SUM_0_) );
  FADDX1_RVT intadd_4_U6 ( .A(intadd_4_B_1_), .B(price[2]), .CI(intadd_4_n6), 
        .CO(intadd_4_n5), .S(intadd_4_SUM_1_) );
  FADDX1_RVT intadd_4_U5 ( .A(intadd_4_B_2_), .B(price[3]), .CI(intadd_4_n5), 
        .CO(intadd_4_n4), .S(intadd_4_SUM_2_) );
  FADDX1_RVT intadd_4_U4 ( .A(intadd_4_B_3_), .B(price[4]), .CI(intadd_4_n4), 
        .CO(intadd_4_n3), .S(intadd_4_SUM_3_) );
  FADDX1_RVT intadd_4_U3 ( .A(intadd_4_B_4_), .B(price[5]), .CI(intadd_4_n3), 
        .CO(intadd_4_n2), .S(intadd_4_SUM_4_) );
  FADDX1_RVT intadd_4_U2 ( .A(intadd_4_B_5_), .B(price[6]), .CI(intadd_4_n2), 
        .CO(intadd_4_n1), .S(intadd_4_SUM_5_) );
  INVX0_RVT U1 ( .A(intadd_4_SUM_5_), .Y(change[6]) );
  INVX0_RVT U2 ( .A(intadd_4_SUM_2_), .Y(change[3]) );
  INVX0_RVT U3 ( .A(intadd_4_SUM_4_), .Y(change[5]) );
  XOR2X1_RVT U4 ( .A1(intadd_4_n1), .A2(credit[7]), .Y(change[7]) );
  INVX0_RVT U5 ( .A(intadd_4_SUM_0_), .Y(change[1]) );
  INVX0_RVT U6 ( .A(intadd_4_SUM_1_), .Y(change[2]) );
  INVX0_RVT U7 ( .A(intadd_4_SUM_3_), .Y(change[4]) );
  INVX0_RVT U8 ( .A(price[0]), .Y(n1) );
  NOR2X0_RVT U9 ( .A1(n1), .A2(credit[0]), .Y(intadd_4_CI) );
  INVX0_RVT U10 ( .A(credit[5]), .Y(intadd_4_B_4_) );
  INVX0_RVT U11 ( .A(credit[1]), .Y(intadd_4_B_0_) );
  INVX0_RVT U12 ( .A(credit[2]), .Y(intadd_4_B_1_) );
  INVX0_RVT U13 ( .A(credit[3]), .Y(intadd_4_B_2_) );
  INVX0_RVT U14 ( .A(credit[4]), .Y(intadd_4_B_3_) );
  INVX0_RVT U15 ( .A(credit[6]), .Y(intadd_4_B_5_) );
  AO21X1_RVT U16 ( .A1(credit[0]), .A2(n1), .A3(intadd_4_CI), .Y(change[0]) );
endmodule
